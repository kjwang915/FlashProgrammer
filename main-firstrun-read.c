		...
		if (usb_read_ready()) {
			...
			if (strncmp((char *)cmd, "m", 1) == 0) {
				...
				for (block = 11; block < 102; block = block + 10) {
					...
					//result = partial_write(address, mylen, write_buffer2, 10000); 
					...
					// partial program the page
					//result = partial_write(address, mylen, write_buffer2, 7500); 
					...
					// partial program the page
					//result = partial_write(address, mylen, write_buffer2, 2000); 
