...
// Most of this was already defined in the excellent LPC214x.h that we use
// So it must be commented out here to avoid conflicts
...
extern void  USB_ConfigEP   (BYTE *pEPD);
